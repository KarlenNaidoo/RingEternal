...
namespace RingEternal.MyCamera {
	...
	public class CameraController : MonoBehaviour {
        ...
        [Header("References")]
		[SerializeField] Transform target; // The target Transform to follow
		...
		public void UpdateInput() {
            if (!cam.enabled)
            {
                Debug.Log("Camera disabled, cannot execute CameraController Script");
                return;
            }
		...
		public void UpdateTransform(float deltaTime) {
			...
			if (target != null) {
                ...
                //Debug.Log("Translating the camera to " + position);
			}
